...
This repository provides Terraform configuration files to automate the deployment of the Datacenter in a Box solution described in the [NSX Easy Adotion Design Guide Document](communities.vmware.com/t5/VMware-NSX-Documents/NSX-Easy-Adoption-Design-Guide/ta-p/2936898). Running the automation requires a machine with Terraform installed. This branch requires using the NSX Terraform provider v3.6.0 available at [link](https://github.com/vmware/terraform-provider-nsxt)
